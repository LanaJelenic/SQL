    ...
    return (
      <Container>
        <Form onSubmit={this.handleSubmit}>
            ...
            <Col key="1" sm={12} lg={6} md={6}>
              ...
              <Form.Group className="mb-3" controlId="ime_Autora">
                ...
                <Form.Control
                  ...
                  name="ime_Autora"
                  placeholder=""
                  defaultValue={knjiga.ime_Autora}
                  required
                />
              </Form.Group>
              ...
              <Form.Group className="mb-3" controlId="prezime_Autora">
                ...
                <Form.Control
                  ...
                  name="prezime_Autora"
                  placeholder=""
                  defaultValue={knjiga.prezime_Autora}
                />
              </Form.Group>
              ...
              <Form.Group className="mb-3" controlId="br_stranica">
                ...
                <Form.Control
                  ...
                  name="br_stranica"
                  placeholder=""
                  defaultValue={knjiga.br_stranica}
                />
              </Form.Group>
          ...
          <Row>
            <Col>
              <Link className="btn btn-danger gumb" to={`/knjige`}>
                Odustani
              </Link>
            </Col>
            <Col>
